...
const addResources = (i18n: any, language: any, resources: any) => {
  Object.keys(resources).forEach(key => {
    i18n.addResourceBundle(language, key, resources[key], true);
  });
};

const loadi18n = (i18nInstance: unknown, i18nResources: any) => {
  Object.keys(i18nResources).forEach(key => {
    addResources(i18nInstance, key, i18nResources[key]);
  });
};

const initializeI18next = (i18nResources: unknown) => {
